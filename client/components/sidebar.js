...
const SideBar = () => {
  ...
  return (
    <div class="header-container">
      ...
      <ul class="nav-list">
        <Link
          class={`${location == "/" ? "Mui-selected" : ""} nav-item`}
          href="/"
        >
          <div class="nav-icon">
            <svg
              class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium svg-icon"
              focusable="false"
              aria-hidden="true"
              viewBox="0 0 24 24"
        ...
        <Link
          class={`${location == "/sendstream" ? "Mui-selected" : ""} nav-item`}
          href="/sendstream"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">Send Stream</h6>
          </div>
        </Link>
        <Link
          class={`${location == "/wrap" ? "Mui-selected" : ""} nav-item`}
          href="/wrap"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">Wrap / Unwrap</h6>
          </div>
        </Link>
        <Link
          class={`${location == "/bridge" ? "Mui-selected" : ""} nav-item`}
          href="/bridge"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">Bridge</h6>
          </div>
        </Link>
        <Link
          class={`${location == "/history" ? "Mui-selected" : ""} nav-item`}
          href="/history"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">Activity History</h6>
          </div>
        </Link>
        <Link
          class={`${location == "/safes" ? "Mui-selected" : ""} nav-item`}
          href="/safes"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">My safes</h6>
          </div>
        </Link>
        <Link
          class={`${location == "/ecosystem" ? "Mui-selected" : ""} nav-item`}
          href="/ecosystem"
        >
          <div class="nav-icon">
            <svg
          ...
          <div class="nav-text">
            <h6 class="nav-link-title">Ecosystem</h6>
          </div>
        </Link>
      </ul>
      <div class="css-16ufse0">
        <div class="css-1rbrapn">
          <div class="nav-item">
            ...
            <div class="nav-text">
              <h6 class="nav-link-title">More</h6>
            </div>
          </div>
          <div class="nav-item">
            <div class="css-6as02q">
              <svg
                class="MuiSvgIcon-root MuiSvgIcon-fontSizeSmall svg-icon"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
            ...
            <div class="nav-text">
              <h6 class="nav-link-title">Settings</h6>
            </div>
          </div>
        </div>
      </div>
